...
const PlaygroundHub = () => {
  return (
    <div className="p-6">
      ...
      <h1 className="text-3xl font-semibold mb-6">Playground Hub</h1>
      <p>Tools I use:</p>

      {/* Navigation Buttons */}
      <div className="mt-6 space-y-4">
        <a className="align-middle text-center underline flex" href="https://flowbite.com/icons/">SVG Icons From Flowbite
          <svg
          ...
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1A46DF" viewBox="0 0 24 24">
